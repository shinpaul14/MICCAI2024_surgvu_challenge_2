...
def build_configargparser(parser):
    ...
    trainer_group.add_argument("--task_features", type=int, default=25)
    trainer_group.add_argument("--fold", type=int, default=0)
    trainer_group.add_argument("--exp_name", type=str, default='exp')
    trainer_group.add_argument("--task", type=str, default='step')
    trainer_group.add_argument("--weight", default=True)
    trainer_group.add_argument("--teacher_exp_name", type=str, default='teahcer_exp')
    trainer_group.add_argument("--reverse", default=False)
    # trainer_group.add_argument("--pretrained", default=True)
